...
- `fetch_borrow_rate_histories(self, codes: Strings = None, since: Int = None, limit: Int = None, params: dict = {})`
...
- `fetch_cross_borrow_rates(self, params: dict = {})`
...
- `fetch_deposit(self, id: str, code: Str = None, params: dict = {})`
...
- `fetch_mark_price(self, symbol: str, params: dict = {})`
- `fetch_mark_prices(self, symbols: Strings = None, params: dict = {})`
- `fetch_market_leverage_tiers(self, symbol: str, params: dict = {})`
- `fetch_markets_by_type(self, type: object, params: dict = {})`
...
- `fetch_open_interest_history(self, symbol: str, timeframe: str = '1d', since: Int = None, limit: Int = None, params: dict = {})`
...
- `fetch_position_mode(self, symbol: Str = None, params: dict = {})`
...
- `fetch_transfer(self, id: str, code: Str = None, params: dict = {})`
- `fetch_transfers(self, code: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
- `fetch_underlying_assets(self, params: dict = {})`
- `fetch_withdrawal(self, id: str, code: Str = None, params: dict = {})`
...
- `convert_to_instrument_type(self, type: object)`
- `describe(self)`
...
- `modify_margin_helper(self, symbol: str, amount: object, type: object, params: dict = {})`
- `nonce(self)`
...
- `public_get_market_books_rpi(request)`
...
- `public_get_market_call_auction_details(request)`
...
- `public_get_public_event_contract_events(request)`
- `public_get_public_event_contract_markets(request)`
- `public_get_public_event_contract_series(request)`
- `public_get_public_vip_interest_rate_loan_quota(request)`
- `public_get_public_mm_instrument_types(request)`
- `public_get_public_delta_hedge_currencies(request)`
...
- `public_get_rubik_stat_contracts_long_short_position_ratio_contract_top_trader(request)`
...
- `public_get_support_announcement_types(request)`
...
- `private_get_fiat_deposit_payment_methods(request)`
- `private_get_fiat_withdrawal_payment_methods(request)`
- `private_get_fiat_deposit_order_history(request)`
- `private_get_fiat_deposit(request)`
- `private_get_fiat_withdrawal_order_history(request)`
- `private_get_fiat_withdrawal(request)`
- `private_get_fiat_buy_sell_currencies(request)`
- `private_get_fiat_buy_sell_currency_pair(request)`
- `private_get_fiat_buy_sell_history(request)`
...
- `private_get_account_subtypes(request)`
...
- `private_get_tradingbot_dca_ongoing_list(request)`
- `private_get_tradingbot_dca_history_list(request)`
- `private_get_tradingbot_dca_orders(request)`
- `private_get_tradingbot_dca_position_details(request)`
- `private_get_tradingbot_dca_cycle_list(request)`
...
- `private_get_finance_flexible_loan_emode_info(request)`
- `private_get_finance_okusd_limits(request)`
- `private_get_finance_okusd_account(request)`
- `private_get_finance_okusd_subscribe_history(request)`
- `private_get_finance_okusd_redeem_history(request)`
- `private_get_finance_okusd_rewards_history(request)`
- `private_get_finance_okusd_rate_history(request)`
- `private_get_finance_stable_rewards_product_info(request)`
- `private_get_finance_stable_rewards_balance(request)`
- `private_get_finance_stable_rewards_apy_history(request)`
- `private_get_users_glp_todayperformance(request)`
- `private_get_users_glp_historicalperformance(request)`
...
- `private_get_finance_sfp_dcd_currency_pair(request)`
- `private_get_finance_sfp_dcd_order_status(request)`
- `private_get_finance_sfp_dcd_order_history(request)`
- `private_get_affiliate_invitee_detail(request)`
- `private_get_affiliate_performance_summary(request)`
- `private_get_affiliate_invitee_list(request)`
- `private_get_affiliate_link_list(request)`
- `private_get_affiliate_co_inviter_list(request)`
- `private_get_affiliate_sub_affiliate_list(request)`
...
- `private_post_fiat_create_withdrawal(request)`
- `private_post_fiat_cancel_withdrawal(request)`
- `private_post_fiat_buy_sell_quote(request)`
- `private_post_fiat_buy_sell_trade(request)`
...
- `private_post_account_set_riskoffset_amt(request)`
...
- `private_post_account_demo_adjust_balance(request)`
...
- `private_post_tradingbot_grid_copy_order_algo(request)`
...
- `private_post_tradingbot_dca_create(request)`
- `private_post_tradingbot_dca_amend_order_algo(request)`
- `private_post_tradingbot_dca_stop(request)`
- `private_post_tradingbot_dca_orders_manual_buy(request)`
- `private_post_tradingbot_dca_settings_reinvestment(request)`
- `private_post_tradingbot_dca_settings_take_profit(request)`
- `private_post_tradingbot_dca_margin_add(request)`
- `private_post_tradingbot_dca_margin_reduce(request)`
- `private_post_tradingbot_recurring_add_investment(request)`
- `private_post_tradingbot_recurring_amend_price_range(request)`
- `private_post_tradingbot_recurring_amend_recurring_amount(request)`
- `private_post_tradingbot_recurring_amend_recurring_time(request)`
- `private_post_tradingbot_recurring_pause(request)`
- `private_post_tradingbot_recurring_restart(request)`
...
- `private_post_finance_flexible_loan_borrow(request)`
- `private_post_finance_flexible_loan_repay(request)`
- `private_post_finance_okusd_subscribe(request)`
- `private_post_finance_okusd_redeem(request)`
...
- `private_post_finance_sfp_dcd_trade(request)`
- `private_post_finance_sfp_dcd_redeem_quote(request)`
- `private_post_finance_sfp_dcd_redeem(request)`
...
- `describe(self)`
- `get_url(self, channel: Str, access: str = 'public')`
- `subscribe_multiple(self, access: str, channel: str, symbols: Strings = None, params: dict = {})`
- `subscribe(self, access: str, messageHash: str, channel: str, symbol: Str, params: dict = {})`
...
- `watch_funding_rate(self, symbol: str, params: dict = {})`
- `watch_funding_rates(self, symbols: Strings = None, params: dict = {})`
...
- `watch_mark_price(self, symbol: str, params: dict = {})`
- `watch_mark_prices(self, symbols: Strings = None, params: dict = {})`
- `un_watch_tickers(self, symbols: Strings = None, params={})`
- `watch_bids_asks(self, symbols: Strings = None, params: dict = {})`
- `watch_liquidations_for_symbols(self, symbols: list[str], since: Int = None, limit: Int = None, params: dict = {})`
- `watch_my_liquidations_for_symbols(self, symbols: list[str], since: Int = None, limit: Int = None, params: dict = {})`
...
- `order_to_trade(self, order: dict, market: Market = None)`
...
- `cancel_orders_ws(self, ids: list[str], symbol: Str = None, params: dict = {})`
- `cancel_all_orders_ws(self, symbol: Str = None, params: dict = {})`

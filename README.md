...
- `fetch_borrow_rate_histories(self, codes: Strings = None, since: Int = None, limit: Int = None, params={})`
...
- `fetch_markets_by_type(self, type: object, params={})`
...
- `describe(self)`
- `edit_order_request(self, id: str, symbol: Str, type: object, side: object, amount: Num = None, price: Num = None, params={})`
- `edit_order(self, id: str, symbol: str, type: OrderType, side: OrderSide, amount: Num = None, price: Num = None, params={})`
- `modify_margin_helper(self, symbol: str, amount: object, type: object, params={})`
- `nonce(self)`
...
- `subscribe_multiple(self, access: object, channel: object, symbols: Strings = None, params={})`
- `subscribe(self, access: object, messageHash: object, channel: object, symbol: object, params={})`
...
- `watch_funding_rates(self, symbols: Strings = None, params={})`
...
- `order_to_trade(self, order: object, market: Market = None)`
